...
def test_convert_svg_to_png():
    input_file = '/tmp/svg_logo.png'
    output_file = '/tmp/svg_logo_converted.png'
...
def test_convert_png_to_gif():
    input_file = '/tmp/sun_image.png'
    output_file = '/tmp/sun_image_converted.gif'

    # Download PNG image
    download_image('https://www.svgheart.com/wp-content/uploads/2020/06/sun-free-svg-cutting-file.png', input_file)
...
def test_convert_svg_to_jpeg():
    input_file = '/tmp/svg_logo.png'
    output_file = '/tmp/svg_logo_converted.jpeg'
...
def lambda_handler(event, context):
    ...
    test_convert_svg_to_png()
    test_convert_png_to_gif()
    test_convert_svg_to_jpeg()
